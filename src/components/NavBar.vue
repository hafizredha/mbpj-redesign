...
<template>
    <header class="fixed top-0 left-0 right-0 p-[inherit] border-b-1 border-gray-200/20 md:border-none transition-all z-99999 overflow-hidden" 
    :class="[
        isOpen ? 'bg-white duration-100 ease-in' : 'bg-transparent duration-600 delay-300 ease-out',
        isScrolled ? 'bg-white shadow-md duration-300 ease-in' : 'bg-transparent duration-600 delay-300 ease-out'
    ]">
        <div class="max-w-6xl m-auto flex justify-between items-center">
            <div class="flex gap-3 items-center">
                ...
                <p class="text-xs sm:text-lg font-medium duration-600 delay-300 ease-out" :class="isScrolled ? 'text-black' : ' text-white'">Petaling Jaya Municipality</p>
            </div>
            <div class="flex items-center gap-5">
                ...
                :class="isOpen ? 'max-h-screen' : 'max-h-0'">
                    ...
                    :class="isScrolled ? 'text-black/80' : ' text-white'">
                        <li>
