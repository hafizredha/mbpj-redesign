...
<template>
    <div class="w-full h-[4dvh] flex">
        <p class="w-auto h-full bg-red-500 text-xs text-white p-2 sm:text-sm flex items-center justify-center font-bold">Announcements</p>
        <div class="w-auto h-full overflow-hidden whitespace-nowrap justify-items-center content-center flex-1">
            <div class="relative w-full h-full overflow-hidden text-xs sm:text-sm py-2 border-b-1 border-[#E6E6E6]">
